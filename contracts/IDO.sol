...
contract IDOToken is ERC20, Ownable {
  ...
  // 定义 USDT 代币的地址
  address public usdtAddress = 0xe2899bddFD890e320e643044c6b95B9B0b84157A;//0x606D35e5962EC494EAaf8FE3028ce722523486D2;
  ...
  function buyToken(uint256 amount) public {
      ...
      // 计算购买数量
      uint256 buyNum = amount;//amount / idoPrice * 10 ** 18;
      // 标记用户已购买
